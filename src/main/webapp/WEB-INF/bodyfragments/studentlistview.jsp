...
<h2 style="padding: 30px">Оқушылар тізімі</h2>
  ...
  <sf:form method="post" action="${pageContext.request.contextPath}/searchUser" modelAttribute="form">
    ...
    <div class="row">
      <div class="col-md-6 mb-4">
        <div class="form-outline">
          ...
          <label class="form-label" for="genre"> Оқушы атымен іздеу</label>
        </div>
      </div>
    </div>
    ...
    <div>
      ...
      <input class="btn btn-primary" type="submit" value="Қалпына келтіру" name="reset"/>
    </div>
