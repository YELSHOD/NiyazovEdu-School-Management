...
public class MarksheetCtl {
	...
	public String getMarksheet(@Valid @ModelAttribute("form")MarksheetForm form,  BindingResult bindingResult, Model model) {
	...
	public String feathSubject(@Valid @ModelAttribute("form")MarksheetForm form,  BindingResult bindingResult, Model model) {
